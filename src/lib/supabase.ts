...
const supabaseService = process.env.SUPABASE_SERVICE_ROLE_KEY!; // Saved as supabaseService
...
export const supabaseAdmin = 
  typeof window === 'undefined' && supabaseService
    ? createClient(supabaseUrl, supabaseService, {
        auth: { persistSession: false },
      })
    : null; // If running in the browser, return null safely instead of crashing the site!